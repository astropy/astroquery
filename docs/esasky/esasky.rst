...
.. doctest-remote-data::
    ...
    >>> result = ESASky.query_region_catalogs(coordinate="M51", radius=10 * u.arcmin, catalogs=["HSC", "XMM-OM"])
...
.. doctest-remote-data::
    ...
    >>> result = ESASky.query_region_catalogs(coordinate="M51", radius=10 * u.arcmin, catalogs="all")
    >>> result = ESASky.query_region_catalogs(coordinate="M51", radius="10 arcmin")
...
.. doctest-remote-data::
    ...
    >>> result = ESASky.query_region_maps(coordinate="M51", radius=10 * u.arcmin, missions="all")
    >>> result = ESASky.query_region_spectra(coordinate="M51", radius=10 * u.arcmin, missions="all")
...
.. doctest-remote-data::
    ...
    >>> table_list = ESASky.query_region_maps(coordinate="V* HT Aqr", radius="15 arcmin", missions=['Herschel', 'ISO-IR'])
...
.. doctest-remote-data::
    ...
    >>> table_list = ESASky.query_region_spectra(coordinate="Gaia DR3 4512810408088819712", radius="6.52 arcmin",
...
.. doctest-remote-data::
    ...
    >>> from astroquery.esasky import ESASky
    >>> result = ESASky.query_region_spectra(coordinate='[SMB88] 6327', radius='1 arcmin', missions=['HERSCHEL'])
