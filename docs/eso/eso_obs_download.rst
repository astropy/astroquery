...
.. doctest-remote-data::
    >>> data_files = eso.retrieve_data(table['dp_id'][:2], destination="./eso_data/") # doctest: +SKIP
...
.. doctest-remote-data::
    ...
    >>> data_files = eso.retrieve_data(table['dp_id'][:2], with_calib="raw") # doctest: +SKIP

.. doctest-remote-data::

    >>> # Download science data with processed calibrations
    >>> data_files = eso.retrieve_data(table['dp_id'][:2], with_calib="processed") # doctest: +SKIP
