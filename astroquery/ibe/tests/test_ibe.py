...
DATA_FILES = {
    ...
    ('http://irsa.ipac.caltech.edu/ibe/search/ptf/images/', None): 'tables.html',
    ('http://irsa.ipac.caltech.edu/ibe/search/ptf/images/level1', frozenset((('FORMAT', 'METADATA'),))): 'columns.txt',
    ('http://irsa.ipac.caltech.edu/ibe/search/ptf/images/level1', frozenset((('where', 'expid <= 43010'), ('POS', '148.969687,69.679383'), ('INTERSECT', 'OVERLAPS')))): 'pos.txt',
    ('http://irsa.ipac.caltech.edu/ibe/search/ptf/images/level1', frozenset((('where', "ptffield = 4808 and filter='R'"), ('INTERSECT', 'OVERLAPS')))): 'field_id.txt'}
