...
from astroquery.gaia.tapplus.conn.tapconn import TapConn
from astroquery.gaia.tapplus.xmlparser.tableSaxParser import TableSaxParser
from astroquery.gaia.tapplus.model.job import Job
from datetime import datetime
from astroquery.gaia.tapplus.gui.login import LoginDialog
from astroquery.gaia.tapplus.xmlparser.jobSaxParser import JobSaxParser
from astroquery.gaia.tapplus.xmlparser.jobListSaxParser import JobListSaxParser
from astroquery.gaia.tapplus.xmlparser import utils
from astroquery.gaia.tapplus.model.filter import Filter
...
class TapPlus(object):
    ...
    def __init__(self, url=None, host=None, server_context=None, 
        ...
        if verbose:
            print ("Created TAP+ (v"+VERSION+") connection to:\n" + str(self.__connHandler))
        pass
