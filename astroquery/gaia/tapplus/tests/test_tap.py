...
from astroquery.gaia.tapplus.conn.tests.DummyConnHandler import DummyConnHandler
from astroquery.gaia.tapplus.conn.tests.DummyResponse import DummyResponse
