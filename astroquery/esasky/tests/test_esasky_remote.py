...
class TestESASky:
    ...
    def test_esasky_query_region_maps(self):
        result = ESASky.query_region_maps(coordinate="M51", radius="5 arcmin")
        assert isinstance(result, TableList)
    ...
    def test_esasky_query_region_catalogs(self):
        result = ESASky.query_region_catalogs(coordinate="M51", radius="5 arcmin")
        assert isinstance(result, TableList)
    ...
    def test_esasky_query_region_spectra(self):
        result = ESASky.query_region_spectra(coordinate="M51", radius="5 arcmin")
        assert isinstance(result, TableList)
