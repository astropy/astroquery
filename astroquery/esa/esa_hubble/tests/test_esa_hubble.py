...
from astroquery.esa.esa_hubble import ESAHubbleClass
from astroquery.esa.esa_hubble.tests.dummy_handler import DummyHandler
from astroquery.esa.esa_hubble.tests.dummy_tap_handler import DummyHubbleTapHandler
