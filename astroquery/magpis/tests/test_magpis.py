...
def test_get_images_async(patch_post, patch_parse_coordinates):
    response = magpis.core.Magpis.get_images_async(coord.Galactic(10.5, 0.0, unit=(u.deg, u.deg)),
...
def test_get_images(patch_post, patch_parse_coordinates):
    image = magpis.core.Magpis.get_images(coord.Galactic(10.5, 0.0, unit=(u.deg, u.deg)))
