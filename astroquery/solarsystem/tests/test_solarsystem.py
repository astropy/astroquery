...
def test_elements_query(patch_request):
    ...
    npt.assert_allclose(
        [2451544.5,
         ...
         2.766494282136041E+00,  2.983318431060230E+00,  1.680711192752127E+03,
        ],
        [res['datetime_jd'],
...
def test_elements_vectors(patch_request):
    ...
    npt.assert_allclose(
        [2451544.5,
         -2.377530254715913E+00,  8.007773098011088E-01,  4.628376171505864E-01,
         -3.605422534068209E-03, -1.057883330464988E-02,  3.379791158988872E-04,
         1.473392692285918E-02,  2.551100364907553E+00,  1.007960852643289E-04,
        ],
        [res['datetime_jd'],
         res['x'], res['y'], res['z'],
