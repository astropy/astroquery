...
The following modules have been completed using a common API:
  ...
  * `FIRST <http://astroquery.readthedocs.io/en/latest/first/first.html>`_: Faint Images of the Radio Sky at Twenty-cm. 20-cm radio images of the extragalactic sky from the VLA.
